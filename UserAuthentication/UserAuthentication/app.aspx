<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="app.aspx.cs" Inherits="UserAuthentication.app" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Panel ID="pnl_login_0" runat="server">
            <h1>Your Account Does not Exist</h1>
            <p>Register an account</p>
            <asp:Button ID="btn_GoRegister" runat="server" Text="Register" OnClick="btn_GoRegister_Click" />
        </asp:Panel>
                <asp:Panel ID="pnl_login_2" runat="server">
            <h1>Either your Password or Email are incorrect</h1>
            <p>Go Back to the Login Page</p>
            <asp:Button ID="btn_return_login" runat="server" Text="Register" OnClick="btn_GoRegister_Click" />
        </asp:Panel>
        <asp:Panel ID="pnl_login_1" runat="server">
            <!-- Wrapper -->
            <div id="wrapper">
...
================================================== -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <!-- Image Box -->
                            <a href="#" class="img-box" data-background-image="images/popular-location-01.jpg">
                        ...
                        <div class="col-md-8">
                            ...
                            <!-- Image Box -->
                            <a href="#" class="img-box" data-background-image="images/popular-location-02.jpg">
                                <div class="img-box-content visible">
                                    <h4>Los Angeles</h4>
                        ...
                        <div class="col-md-8">
                            ...
                            <!-- Image Box -->
                            <a href="#" class="img-box" data-background-image="images/popular-location-03.jpg">
                                <div class="img-box-content visible">
                                    <h4>San Francisco </h4>
                ...
                <section class="fullwidth margin-top-70 margin-bottom-65" data-background-color="#fff">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="headline centered margin-bottom-50">Get an Exposure For Your Listing
                                </h3>
                            </div>
                        </div>
...
================================================== -->
                <div id="footer" class="dark">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-3  col-sm-12">
                                ...
                                <div class="text-widget">
                                    <span>Lisboa</span>
                                    <br>
                                    Phone: <span>(+351) 999 999 999 </span>
                                    <br>
                                    E-Mail:<span> <a href="#">office@example.com</a> </span>
                                    <br>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyrights">MIT License</div>
                            </div>
                        </div>
